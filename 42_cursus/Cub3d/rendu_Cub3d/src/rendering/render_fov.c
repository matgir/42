...
/*   Updated: 2024/01/16 21:15:29 by mgirardo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cub3d.h"

void	dda(t_player *player, t_vars *var, t_ray *ray, int color) //ajouter au .h //AJOUT
{
	int	i;
	int	x;
	int	y;
...
void	render_fov(t_vars *var, t_player *player, int color) //AJOUT
{
	int	i;
