...
const material = new THREE.MeshStandardMaterial({color: 0xFF99C9 , wireframe: false
...
const directionalLight = new THREE.DirectionalLight(0x5500FF, 1);
...
return function cleanup() {
    console.log("cleanup 1_space_cubes.js");
